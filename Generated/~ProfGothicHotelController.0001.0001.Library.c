    ...
    void)
{
    ...
    while (ent_transition != NULL) {
        ...
        if (
            ent_transition->rel_moves_to_next_state_head != 
            ent_transition->rel_moves_to_next_state_tail) {
        ...
        if (
            ent_transition->rel_determines_current_event_head != 
            ent_transition->rel_determines_current_event_tail) {
    ...
    while (ent_state != NULL) {
        ...
        if (
            ent_state->rel_marks_current_state_for_state_machine_head != 
            ent_state->rel_marks_current_state_for_state_machine_tail) {
